...
class UserData:
    ...
    def add_update_user(self, refresh_token, user_id):
        """Add or update a user and token data.

        Takes takes the user refresh_token and checks and adds to the database.

        Args:
            refresh_token: alphanumeric values generated by the SpotifyAPI and
    ...
    def get_user_top_trx(self, spot_session, user_id):
        ...
        Args:
            'spot_session': The spotify session activted for the given user.
        ...
        Returns:
            ...
            long term
            'track_ids': all of the track ids collected from the user tops list
        """
